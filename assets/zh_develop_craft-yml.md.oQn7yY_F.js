import{_ as i,c as a,o as n,aj as l}from"./chunks/framework.C2AwuPrQ.js";const c=JSON.parse('{"title":"craft.yml 配置详解","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"zh/develop/craft-yml.md","filePath":"zh/develop/craft-yml.md"}'),p={name:"zh/develop/craft-yml.md"};function t(e,s,h,k,r,d){return n(),a("div",null,[...s[0]||(s[0]=[l(`<h1 id="craft-yml-配置详解" tabindex="-1">craft.yml 配置详解 <a class="header-anchor" href="#craft-yml-配置详解" aria-label="Permalink to “craft.yml 配置详解”">​</a></h1><div class="language-yaml"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># PHP version to build (default: 8.5)</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  GITHUB_TOKEN</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">your-github-token</span></span></code></pre></div>`,2)])])}const E=i(p,[["render",t]]);export{c as __pageData,E as default};
